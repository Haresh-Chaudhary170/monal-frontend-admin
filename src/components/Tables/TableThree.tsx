...
const TableThree = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-1 pb-1 pt-1 shadow-default  dark:bg-boxdark sm:px-1 xl:pb-1">
                ...
                <td className="border-b border-[#eee] px-4 py-5 ">
                  <div className="flex items-center space-x-3.5">
                    <button
                      ...
                      onClick={() => router.push("/menu/subcategory")}
                    >
                      <svg

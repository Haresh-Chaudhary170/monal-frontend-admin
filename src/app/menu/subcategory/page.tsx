...
const CalendarPage = () => {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb prevPageName="Menu" pageName="Subcategory" />
      <div className="rounded-sm border border-stroke bg-white px-1 pb-2.5 pt-1 shadow-default sm:px-1 xl:pb-1">
          ...
          <table className="w-full table-auto">
            ...
            <tbody>
              {packageData.map((packageItem, key) => (
                <tr key={key}>
                  <td className="border-b border-[#eee] px-1 py-5 pl-2 xl:pl-11">
                    <span className="cursor-grab font-medium text-black dark:text-white">
                      {dragAbleIcon}
                    </span>
                  </td>
                  <td className="border-b border-[#eee] px-1 py-5 pl-2 xl:pl-11">
                  ...
                  <td className="border-b border-[#eee] px-1 py-5 pl-2 xl:pl-11">
                    <h5 className="font-medium text-black dark:text-white">
                      {packageItem.byTheGlass}
                    </h5>
                  </td>
                  <td className="border-b border-[#eee] px-1 py-5 pl-2 xl:pl-11">
                    <h5 className="font-medium text-black dark:text-white">
                      {packageItem.showToHome}
                    </h5>
                  </td>
                  <td className="border-b border-[#eee] px-1 py-5 ">
                    <div className="flex items-center space-x-3.5">
                      <button
                        className="hover:text-brown"
                        onClick={() => router.push("/menu/subcategory/item")}
                      >
                        <svg
                      ...
                      <button className="hover:text-brown">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="18"
                          height="18"
